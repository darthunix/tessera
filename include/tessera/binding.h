/* Slot-binding protocol shared by independent Tessera extensions. */
#ifndef TESSERA_BINDING_H
#define TESSERA_BINDING_H
...
#define TESS_BINDING_OPS_ABI_VERSION 0

typedef struct TessBinding TessBinding;
typedef struct TupleTableSlot TupleTableSlot;

/*
 * Operations for one producer-to-consumer connection through a tuple slot.
 *
 ...
 */
typedef struct TessBindingOps
{
	/* Changes when this operation table becomes incompatible. */
	uint32		abi_version;
	...
	TessBinding *(*find) (TupleTableSlot *slot);
